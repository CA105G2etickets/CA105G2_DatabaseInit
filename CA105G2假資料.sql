...
TO_DATE('2019-01-22','YYYY-MM-DD'), TO_DATE('2019-01-24','YYYY-MM-DD'), 2, 'confirmed', 
...
(EVE_NO, EVETIT_NO, VENUE_NO, EVE_SESSIONNAME, EVE_STARTDATE, EVE_ENDDATE, EVE_ONSALEDATE, EVE_OFFSALEDATE, TICLIMIT, EVE_STATUS)
VALUES
('EV'||LPAD(to_char(EVE_SEQ.NEXTVAL), 5, '0'), 'E0002', 'V002', '2019/01/22 第一場', 
TO_TIMESTAMP('2019-01-22 20:00', 'YYYY-MM-DD HH24:MI'), TO_TIMESTAMP('2019-01-22 23:00', 'YYYY-MM-DD HH24:MI'), 
TO_TIMESTAMP('2018-08-11 11:00', 'YYYY-MM-DD HH24:MI'), TO_TIMESTAMP('2019-01-22 19:00', 'YYYY-MM-DD HH24:MI'), 4, 'normal');
...
(TICAREA_NO, EVE_NO, TICTYPE_NO, TICAREA_COLOR, TICAREA_NAME, TICTOTALNUMBER, TICBOOKEDNUMBER)
VALUES
('ES'||LPAD(to_char(TICAREA_SEQ.NEXTVAL), 8, '0'), 'EV00004', 'ET000019', '#aaff56', '綠213區3300', 1000, 500);
INSERT INTO SEATING_AREA
(TICAREA_NO, EVE_NO, TICTYPE_NO, TICAREA_COLOR, TICAREA_NAME, TICTOTALNUMBER, TICBOOKEDNUMBER)
VALUES
