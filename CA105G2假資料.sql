...
CREATE TABLE TICKET_ORDER(
    ...
    TICKET_ORDER_STATUS VARCHAR2(9) NOT NULL,
...
CREATE TABLE RESALE_ORD(
    ...
    RESALE_ORDSTATUS VARCHAR2(9) NOT NULL,
...
VALUES('T_20181225_'||LPAD(to_char(TICKET_seq.NEXTVAL), 6, '0'),'E000101A01','TO_20181225_000001','M000001','ACTIVE1',TO_TIMESTAMP('2018-12-25 18:40', 'YYYY-MM-DD HH24:MI'),'NONE',0,'NO');
INSERT INTO TICKET (TICKET_NO,TICAREA_NO,TICKET_ORDER_NO,MEMBER_NO,TICKET_STATUS,TICKET_CREATE_TIME,TICKET_RESALE_STATUS,TICKET_RESALE_PRICE,IS_FROM_RESALE) 
VALUES('T_20181225_'||LPAD(to_char(TICKET_seq.NEXTVAL), 6, '0'),'E000101A01','TO_20181225_000001','M000001','ACTIVE1',TO_TIMESTAMP('2018-12-25 18:40', 'YYYY-MM-DD HH24:MI'),'NONE',0,'NO');
INSERT INTO TICKET (TICKET_NO,TICAREA_NO,TICKET_ORDER_NO,MEMBER_NO,TICKET_STATUS,TICKET_CREATE_TIME,TICKET_RESALE_STATUS,TICKET_RESALE_PRICE,IS_FROM_RESALE) 
VALUES('T_20181225_'||LPAD(to_char(TICKET_seq.NEXTVAL), 6, '0'),'E000101A01','TO_20181225_000001','M000002','ACTIVE1',TO_TIMESTAMP('2018-12-25 18:40', 'YYYY-MM-DD HH24:MI'),'NONE',0,'YES');
...
CREATE TABLE GOODS_FAQ (
    ...
    ,CONSTRAINT GOODS_FAQ_FK1 FOREIGN KEY (GOODS_NO) REFERENCES GOODS (GOODS_NO)
    ,CONSTRAINT GOODS_FAQ_FK2 FOREIGN KEY (MEMBER_NO) REFERENCES MEMBER (MEMBER_NO)
    ,CONSTRAINT GOODS_FAQ_FK3 FOREIGN KEY (ADMINISTRATOR_NO) REFERENCES ADMINISTRATOR (ADMINISTRATOR_NO)
    );

CREATE SEQUENCE GOODS_FAQ_SEQ
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
INSERT INTO GOODS_FAQ VALUES 
(
    'GF'||LPAD(TO_CHAR(GOODS_FAQ_SEQ.NEXTVAL),7,'0')
    ,'P0000001'
    ,'M000001'
    ,'A001'
    ,'什麼時候到貨'
...
Insert into ORDER_HISTORY (ORDER_NO,MEMBER_NO,ORDER_PRICE,PAY_METHODS,SHIPPING_METHODS,ORDER_DATE,ORDER_ETD,PICKUP_DATE,RECEIVER_ADD,RECEIVER_NAME,RECEIVER_TEL,ORDER_STATUS) 
    values ('O'||to_char(sysdate,'yyyymmdd')||LPAD(to_char(ORDER_HISTORY_seq.NEXTVAL), 5, '0'),'M000001',2250,'EWALLET','STOREPICKUP',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'320桃園市中壢區福德一路177巷60弄2號','Peter','0912345678','COMPLETE4');
Insert into ORDER_HISTORY (ORDER_NO,MEMBER_NO,ORDER_PRICE,PAY_METHODS,SHIPPING_METHODS,ORDER_DATE,ORDER_ETD,PICKUP_DATE,RECEIVER_ADD,RECEIVER_NAME,RECEIVER_TEL,ORDER_STATUS) 
    values ('O'||to_char(sysdate,'yyyymmdd')||LPAD(to_char(ORDER_HISTORY_seq.NEXTVAL), 5, '0'),'M000002',8000,'CREDITCARD','HOMEDELIVERY',CURRENT_TIMESTAMP,'','','320桃園市中壢區中央路100號','David','0913345678','CANCEL5');
Insert into ORDER_HISTORY (ORDER_NO,MEMBER_NO,ORDER_PRICE,PAY_METHODS,SHIPPING_METHODS,ORDER_DATE,ORDER_ETD,PICKUP_DATE,RECEIVER_ADD,RECEIVER_NAME,RECEIVER_TEL,ORDER_STATUS)
    values ('O'||to_char(sysdate,'yyyymmdd')||LPAD(to_char(ORDER_HISTORY_seq.NEXTVAL), 5, '0'),'M000003',1480,'CREDITCARD','STOREPICKUP',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'320桃園市中壢區樹籽路8號','Sara','0914345678','COMPLETE4');
...
Insert into FAVORITE_GOODS (MEMBER_NO,GOODS_NO) values ('M000001','P0000001');
Insert into FAVORITE_GOODS (MEMBER_NO,GOODS_NO) values ('M000002','P0000002');
