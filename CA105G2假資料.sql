...
Insert into ORDER_DETAIL (ORDER_NO,GOODS_NO,GOODS_BONUS,GOODS_PC) 
    values ('O'||to_char(sysdate,'yyyymmdd')||LPAD(to_char(ORDER_DETAIL_seq.NEXTVAL), 5, '0'),'P0000001',15000,3);
Insert into ORDER_DETAIL (ORDER_NO,GOODS_NO,GOODS_BONUS,GOODS_PC) 
    values ('O'||to_char(sysdate,'yyyymmdd')||LPAD(to_char(ORDER_DETAIL_seq.NEXTVAL), 5, '0'),'P0000002',9999,10);
Insert into ORDER_DETAIL (ORDER_NO,GOODS_NO,GOODS_BONUS,GOODS_PC) 
